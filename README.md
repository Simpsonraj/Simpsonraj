...
| Category | Tools |
|---|---|
| **Databases** | SQL (CTEs, Window Functions, Views) |
...
- 📜 **Data Analytics Certification** (Excel, SQL, Python, Power BI) | Coding Ninjas × IIT Patna
...
*Actively seeking Data Analyst or Business Analyst opportunities*
